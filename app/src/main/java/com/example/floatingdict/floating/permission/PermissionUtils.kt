package com.example.floatingdict.floating.permission
...
import com.example.floatingdict.floating.permission.rom.*
...
object PermissionUtils {
    ...
    internal fun requestPermission(fragment: Fragment) =
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M) when {
            ...
            else -> Timber.i("原生 Android 6.0 以下无需权限申请")
    ...
    private fun commonROMPermissionApply(fragment: Fragment) = when {
        ...
        // 需要做统计效果
        else -> Timber.d("user manually refuse OVERLAY_PERMISSION")
    }
